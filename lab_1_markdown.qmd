...
In this lab session, we will focus on how to collect, save, and read data in R. We will also discuss some ways to manipulate and visualise our datasets. You will also have the chance to share and present the data you have collected with you deskmates!
...
```{r}
# Read the CSV file
data_read <- read.csv("sample_data.csv")
```

## 2.3 Finding data online

Datasets can be also found in various online repositories, such as:![Where to get datasets? Top 10 public dataset finders \| SuperAnnotate](https://assets-global.website-files.com/614c82ed388d53640613982e/635b9f2a6dc18549a914e24d_6320786336c3348556931230_top-public-dataset-finders.png){alt="Where to get datasets? Top 10 public dataset finders | SuperAnnotate" width="464"}

-   [Kaggle](https://www.kaggle.com/datasets) is popular platform for data science competitions, but it also hosts a wide variety of datasets. These datasets cover a range of topics and complexities and can be a great starting point for projects in statistical modelling, data science, and machine learning
...
-   Introduce your datasets to each other - how have collected the data? What questions are you trying to answer with your data?
...
![](https://raw.githubusercontent.com/quarto-dev/quarto-web/main/docs/get-started/hello/rstudio/lter_penguins.png){fig-alt="Illustration of three species of Palmer Archipelago penguins: Chinstrap, Gentoo, and Adelie. Artwork by @allison_horst." style="float:right;" width="310"}
...
In data science, [**dplyr**](https://dplyr.tidyverse.org/) is very popular package. It is a grammar of data manipulation, providing a consistent set of verbs that help you solve the most common data manipulation challenges. To install and load dplyr:
...
-   Use these function, or other ones that you like, investigate your and your deskmate's datasets!

    -   If you run into any problems, try solving it by checking the documentation, using the help function, and discussing with each other!
...
[**ggplot2**](https://ggplot2.tidyverse.org/) is one of (if not the) the most popular data visualisation packages in R - it is a must-have!
...
The scatter plot below shows the relationship between flipper and bill lengths of these penguins.
