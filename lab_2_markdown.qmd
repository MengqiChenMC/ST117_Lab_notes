...
ggplot(df, aes(x = sample)) +
  geom_histogram(aes(y = ..density..), binwidth = 0.08, fill = "lightblue", colour = "black") + 
  # here (y = ..density..) means that we map the y-axis aesthetic to the density of the data,   rather than the count, which is the default.
